...
if (!userReadAgreement()){
	...
	var entriesArr = sgSheet.excelRowArr.map(function (i){return excelEntry2obj(i, schema.req.excel);});
	// Every object in this array is one entry, which is a safety goal in object format
	entriesArr.slice(1).forEach(function (i){obj2mediniEntry(i, schema.req.medini, Metamodel.safetygoals.SafetyRequirement);}); 
